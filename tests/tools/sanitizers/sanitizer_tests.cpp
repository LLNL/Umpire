...
int main(int argc, char* argv[])
{
  ...
  if ((resource_type.find("DEVICE") != std::string::npos) ||
      (resource_type.find("UM") != std::string::npos)) {
  ...
  std::cout << " Conducting sanitizer test with " << strategy << " strategy, " << test_type
            << " test type, and the " << resource_type << " resource." << std::endl;
