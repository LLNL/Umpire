...
void report_and_deallocate(int iteration, std::vector<void*>& ptrs, umpire::Allocator& allocator, T strategy)
{
  ...
  std::cout << std::setw(22)
            ...
            << " Adjusted - Current Size: " << std::setw(12) << allocator.getCurrentSize()
            << " Adjusted - Actual Size: " << std::setw(12) << allocator.getActualSize()
            << std::endl;
}

void allocate_and_check(std::size_t nbytes, std::size_t alignment, std::vector<void*>& ptrs, umpire::Allocator& allocator)
{
