...
{
  ASSERT_THROW(UMPIRE_ERROR(runtime_error, "Test Exception"), umpire::runtime_error);
  ASSERT_THROW(UMPIRE_ERROR(out_of_memory_error, "Test OOM Exception"), umpire::out_of_memory_error);
}
