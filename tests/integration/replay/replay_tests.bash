...
echo $diffprogram -q --recompile $replay_tests_dir/test_output.good umpire.*.0.replay
$diffprogram -q --recompile $replay_tests_dir/test_output.good umpire.*.0.replay
if [ $? -ne 0 ]; then
