...
There is also an example of using the coalescing heuristic to improve QuickPool performance `here <https://umpire.readthedocs.io/en/develop/sphinx/cookbook/dynamic_pool_heuristics.html>`_.
