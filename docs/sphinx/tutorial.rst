...
devices (like GPUs) might not be accessible from the CPU. If you try and access
this memory your program will error! Luckily, Umpire makes it easy to move data
around, and check where it is, as you will see in the following sections.
