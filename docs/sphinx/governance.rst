...
============================
Governance Policy for Umpire
============================

Introduction
============

Umpire is an application-focused API for memory management on NUMA & GPU architectures. This governance policy outlines the rules and processes that guide the development, contributions, and decision-making of the project.
...
- **Members**: See the list of contributors for Umpire [here]{https://github.com/LLNL/Umpire/graphs/contributors}.
- **Responsibilities**:
...
- Most decisions are made based on the consensus of maintainers and contributors or the Technical Steering Committee.
- If consensus cannot be reached, the decision is escalated to the Technical Steering Committee.

Voting
~~~~~~

- For critical decisions (e.g., changing the license, adding/removing maintainers), a vote is initiated among the Technical Steering Committee. Some decisions may involve members of LLNL's WSC program leadership if necessary.
- A decision is approved by a simple majority unless specified otherwise.
...
- See the Contribution guide [here]{https://github.com/LLNL/Umpire/blob/develop/CONTRIBUTING.md}.
...
- All contributors must adhere to the project's [Code of Conduct]{https://github.com/LLNL/Umpire/blob/develop/CODE_OF_CONDUCT.md}.
...
- The release names will correspond to the release names of RAJA and Camp as part of this process. Once the release has been merged, it will be published in the [Releases]{https://github.com/LLNL/Umpire/releases} section of the repo. 

Communication Channels
======================

- The primary communication channel is the GitHub repository (issues, PR comments).
- Other channels may include mailing lists and Slack (See the [README]{https://github.com/LLNL/Umpire/blob/develop/README.md} for details).
