...
# -*- coding: utf-8 -*-
#
# Umpire documentation build configuration file, created by
...
project = u'Umpire'
copyright = u'2016-26, Lawrence Livermore National Security, LLC and Umpire project contributors'
...
version_file = os.path.join(conf_directory, '..', 'VERSION')
with open(version_file, 'r') as f:
    # The full version, including alpha/beta/rc tags.
    release = f.read().strip()
    # Extract X.Y for short version (e.g., "2025.12.0" -> "2025.12")
...
latex_documents = [
    (master_doc, 'Umpire.tex', u'Umpire Documentation',
...
man_pages = [
    (master_doc, 'umpire', u'Umpire Documentation',
     [author], 1)
]
