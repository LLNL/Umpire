...
option(UMPIRE_ENABLE_HEADER_INTROSPECTION "Use header-based introspection for host-accessible memory" On)

if(UMPIRE_ENABLE_HEADER_INTROSPECTION)
  message(STATUS "Header introspection enabled: Only host-accessible memory types are supported.")
  message(STATUS "  See docs/sphinx/features/introspection.rst for details on supported memory types.")
  if(UMPIRE_ENABLE_CUDA OR UMPIRE_ENABLE_HIP OR UMPIRE_ENABLE_SYCL)
    message(STATUS "  GPU support detected: Header introspection works with unified/managed memory only.")
  endif()
endif()
