...
int main(int argc, char* argv[])
{
  ...
  app.add_option("-i,--infile", options.input_file, "Input file created by Umpire library with UMPIRE_REPLAY=On")
      ->required()
  ...
  app.add_flag("--info-only", options.info_only, "Information about replay file, no actual replay performed");

  app.add_flag("--no-demangle", options.do_not_demangle, "Disable demangling of replay file");
  ...
  app.add_option("-p,--use-pool", options.pool_to_use, "Specify pool to use: List, Map, or Quick")
  ...
  app.add_option("--heuristic-parm", options.heuristic_parm, "Specify heuristic parameter to use")
