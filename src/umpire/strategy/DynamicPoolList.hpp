...
class DynamicPoolList : public AllocationStrategy {
 public:
  ...
  static PoolCoalesceHeuristic<DynamicPoolList> percent_releasable(int percentage, bool hwm_switch);
  ...
  static PoolCoalesceHeuristic<DynamicPoolList> blocks_releasable(std::size_t nblocks, bool hwm_switch);
