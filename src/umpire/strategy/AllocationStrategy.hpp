...
class AllocationStrategy {
 ...
 private:
  ...
  virtual void* allocate_resource(camp::resources::Resource const& r, std::size_t bytes);
  ...
  virtual void deallocate_resource(camp::resources::Resource const& r, void* ptr, std::size_t size = 0);
};
