...
PoolCoalesceHeuristic<QuickPool> QuickPool::blocks_releasable(std::size_t nblocks, bool resize_to_hwm)
{
  if (resize_to_hwm)
...
PoolCoalesceHeuristic<QuickPool> QuickPool::percent_releasable(int percentage, bool resize_to_hwm)
{
