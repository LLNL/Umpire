 ...
 * additional memory. To create this mapping the function needs to take in the size 
 * of memory wanted for the allocation. The set location for the allocation by 
 * defult is ./ but can be assigned using enviroment variable "UMPIRE_MEMORY_FILE_DIR"
 * 
  ...
  public MemoryResource
{
  public: 
    ...
    * be returned. With this munmap can be called to deallocated the correct file. 
    * 
