 ...
 */
class HipUnifiedMemoryResource : public HipMemoryResourceProxy<HipUnifiedMemoryResource>, public MemoryResource {
  friend struct HipMemoryResourceProxy<HipUnifiedMemoryResource>;
