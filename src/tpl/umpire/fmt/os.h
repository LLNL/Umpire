...
class windows_error : public system_error {
 ...
 public:
  /**
   \rst
   Constructs a :class:`umpire::fmt::windows_error` object with the description
   of the form
   ...
   **Example**::
     ...
     if (file == HFILE_ERROR) {
       throw umpire::fmt::windows_error(GetLastError(),
...
/**
  ...
  **Example**::
    ...
    auto out = umpire::fmt::output_file("guide.txt");
