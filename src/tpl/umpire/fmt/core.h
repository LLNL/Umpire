...
/**
  ...
  subset of the API. ``umpire::fmt::basic_string_view`` is used for format strings even
...
namespace detail {
void to_string_view(...);
using umpire::fmt::v7::to_string_view;

// Specifies whether S is a string type convertible to umpire::fmt::basic_string_view.
...
/**
  ...
  class and shouldn't be used directly, only via `~umpire::fmt::basic_memory_buffer`.
  \endrst
 */
...
/**
  ...
  `~umpire::fmt::basic_format_args` for passing into type-erased formatting functions
  such as `~umpire::fmt::vformat`.
  \endrst
 */
...
/**
  \rst
  Constructs a `~umpire::fmt::format_arg_store` object that contains references to
  arguments and can be implicitly converted to `~umpire::fmt::format_args`. `Context`
  can be omitted in which case it defaults to `~umpire::fmt::context`.
  See `~umpire::fmt::arg` for lifetime considerations.
  \endrst
 */
...
/**
  \rst
  Constructs a `~umpire::fmt::format_arg_store` object that contains references
  to arguments and can be implicitly converted to `~umpire::fmt::format_args`.
...
/**
  ...
  **Example**::
    ...
    umpire::fmt::print("Elapsed time: {s:.2f} seconds", umpire::fmt::arg("s", 1.23));
  \endrst
 */
...
template <typename Context> class basic_format_args {
 ...
 public:
  ...
  /**
   \rst
   Constructs a `basic_format_args` object from `~umpire::fmt::format_arg_store`.
   \endrst
   */
  template <typename... Args>
...
/**
  ...
  **Example**::
    ...
    #include <fmt/core.h>
    std::string message = umpire::fmt::format("The answer is {}", 42);
  \endrst
*/
...
/**
  ...
  **Example**::
    ...
    umpire::fmt::print(stderr, "Don't {}!", "panic");
  \endrst
 */
template <typename S, typename... Args, typename Char = char_t<S>>
...
/**
  ...
  **Example**::
    ...
    umpire::fmt::print("Elapsed time: {0:.2f} seconds", 1.23);
  \endrst
 */
template <typename S, typename... Args, typename Char = char_t<S>>
